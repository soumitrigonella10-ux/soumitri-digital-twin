...
export default function PublicPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* 3. Sign In Section */}
      <section id="signin" className="min-h-screen flex items-center justify-center py-16 px-4 bg-white">
        <div className="max-w-2xl w-full text-center">
          ...
          {isDemoMode && (
            <div className="bg-gray-50 border border-gray-200 text-gray-700 p-6 mb-8 text-left max-w-md mx-auto rounded-lg">
