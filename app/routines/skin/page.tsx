...
import { Sparkles, Sun, Moon, Calendar, Edit2, Check, X } from "lucide-react";
...
export default function SkinPage() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return filtered;
  }, [skinProducts, activeTimeFilter, activeDayFilter]);
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center text-sm text-gray-400">
        Showing {filteredProducts.length} of {skinProducts.length} skin products
      </div>
    </div>
  );
}
