...
export const productSchema = z.object({
  ...
  routineType: z.enum(["skin", "hair", "body", "bodySpecific", "makeup", "wellness", "workout", "food"]).nullish(),
  bodyAreas: z.array(z.enum(["UA", "IT", "BL", "IA", "B&S"])).nullish(),
  hairPhase: z.enum(["oiling", "washing", "postWash", "daily"]).nullish(),
  timeOfDay: z.enum(["AM", "MIDDAY", "PM", "ANY"]).nullish(),
  weekdays: z.array(z.number().min(0).max(6)).nullish(),
